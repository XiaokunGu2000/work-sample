...
class Car:
    ...
    def __init__(self, hearingrange = 2500, position = SCoordinate(0,0) ,time_slots=20, freq_bands=5 , channelresource = np.zeros((freq_bands, time_slots))):
        ...
        # tmarker and fmarker is the marker of the transmission/index of communication resource
...
# change the vehicle density

for Car_num in range(100,351,25):
    carset = []
    collisionsum = []
    successsing = []
...
plt.plot(k2,aver, label = 'PRR')
plt.ylabel("the average PRR of the vehicles(vehicle number vary from 100-350)")
